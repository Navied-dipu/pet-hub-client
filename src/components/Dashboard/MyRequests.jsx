...
export default function MyRequests({ user }) {
  ...
  return (
    <div className="w-full space-y-8 animate-fadeIn">
      {/* Title & Header */}
      <div>
        <h2 className="text-3xl font-extrabold text-white">My Adoption Requests</h2>
      ...
      {requests.length === 0 ? (
        <div className="text-center py-16 bg-base-100 rounded-2xl border border-base-300 shadow-md">
          ...
          <h3 className="text-xl font-bold text-white">No requests made yet</h3>
          ...
          <Link href="/allpets" className="btn btn-primary btn-sm text-white mt-4 rounded-xl">
            Browse Pets
          </Link>
        </div>
      ) : (
        ...
        <div className="bg-base-100 border border-base-300 rounded-2xl overflow-hidden shadow-lg">
          <div className="overflow-x-auto">
            <table className="table table-zebra w-full text-left">
              {/* Head */}
              <thead className="bg-base-200 text-gray-400 border-b border-base-300">
                <tr>
                  ...
                  <tr key={request._id} className="hover:bg-base-200/50 transition">
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        <div className="relative h-12 w-12 rounded-lg overflow-hidden bg-neutral border border-base-300">
                          <Image
                        ...
                        <div>
                          <span className="font-bold text-white block">{request.petName}</span>
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Link
                          ...
                          className="btn btn-outline border-base-300 hover:bg-base-300 text-white btn-xs rounded flex items-center gap-1"
                        >
                          <FiEye /> View Pet
                        </Link>
                        {/* Cancel Button */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-md bg-base-100 border border-base-300 rounded-2xl shadow-2xl p-6 space-y-4">
            <div className="flex items-center gap-3 text-error">
              ...
              <h3 className="text-xl font-bold text-white">Cancel Request</h3>
            </div>
            <p className="text-sm text-gray-400">
              Are you sure you want to cancel and delete your adoption request for{" "}
              <strong className="text-white">"{requestToDelete.petName}"</strong>? This will remove
              your application.
            </p>
